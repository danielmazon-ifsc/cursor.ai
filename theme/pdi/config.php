...
// extensions.                                                                                                                      
// Global sheets only; page-specific sheets are added in theme_pdi_page_init() (lib.php).
$THEME->sheets = ['app', 'pdi'];
...
// PDI overrides only the drawers layout from Boost so the right drawer can be exposed
// to users with block-edit capability on the saladeconferencias format (which hides
// the left drawer and starts without blocks). All other layouts fall back to boost.
$THEME->layouts = [
    'course' => [
        'theme' => 'pdi',
        'file' => 'drawers.php',
