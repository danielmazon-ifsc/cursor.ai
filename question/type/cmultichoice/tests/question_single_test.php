 ...
 * @author     Ricardo Drummond
 */
class qtype_cmultichoice_single_question_test extends advanced_testcase {

    public function test_get_expected_data() {
        $question = qtype_cmultichoice_test_helper::make_a_cmultichoice_single_question();
    ...
    public function test_is_same_response() {
        ...
        $this->assertFalse($question->is_same_response(
                        array(), array('answer' => '0')));

        $this->assertTrue($question->is_same_response(
                        array('answer' => '0'), array('answer' => '0')));

        $this->assertFalse($question->is_same_response(
                        array('answer' => '0'), array('answer' => '1')));

        $this->assertTrue($question->is_same_response(
                        array('answer' => '2'), array('answer' => '2')));
    }
    ...
    public function test_grading() {
        ...
        $this->assertEquals(array(1, question_state::$gradedright), $question->grade_response($question->prepare_simulated_post_data(array('answer' => 'A'))));
        $this->assertEquals(array(-0.3333333, question_state::$gradedwrong), $question->grade_response($question->prepare_simulated_post_data(array('answer' => 'B'))));
        $this->assertEquals(array(-0.3333333, question_state::$gradedwrong), $question->grade_response($question->prepare_simulated_post_data(array('answer' => 'C'))));
    }
    ...
    public function test_classify_response() {
        ...
        $this->assertEquals(array($mc->id => new question_classified_response(14, 'B', -0.3333333)), $mc->classify_response($mc->prepare_simulated_post_data(array('answer' => 'B'))));
    ...
    public function test_make_html_inline() {
        ...
        $this->assertEquals('<img src="http://example.com/pic.png" alt="Graph" />', $mc->make_html_inline(
