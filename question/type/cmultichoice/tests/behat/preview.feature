...
Feature: Preview a Competency Multichoice question
  As a teacher
  In order to check my Competency Multichoice questions will work for students
  ...
  Scenario: Preview a Competency Multichoice question and submit a partially correct response.
  ...
  @javascript @_switch_window
  Scenario: Preview a Competency Multichoice question and submit a correct response.
    When I click on "Preview" "link" in the "Multi-choice-001" "table_row"
    And I switch to "questionpreview" window
    And I set the field "How questions behave" to "Immediate feedback"
    And I press "Start again with these options"
