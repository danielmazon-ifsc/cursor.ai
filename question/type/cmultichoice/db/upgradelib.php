...
/**
 * Upgrade library code for the cmultichoice question type.
 *
 * @package    qtype
...
/**
 * Class for converting attempt data for cmultichoice questions when upgrading
 ...
 * @author     Ricardo Drummond
 */
class qtype_cmultichoice_qe2_attempt_updater extends question_qtype_attempt_updater {

    protected $order;

    public function is_blank_answer($state) {
        // Blank cmultichoice answers are not empty strings, they rather end in a colon.
