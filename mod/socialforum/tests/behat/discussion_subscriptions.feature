...
Feature: A user can control their own subscription preferences for a discussion
  ...
  Scenario: An optional social forum can have discussions subscribed to
    Given I add a "Social Forum" to section "1" and I fill the form with:
    ...
    Then I should see "Subscribe to this social forum"
    ...
    And I should see "Student One will be notified of new posts in 'Test post subject one' of 'Test social forum name'"
    And I should see "Subscribe to this social forum"
    ...
    And I should see "Student One will NOT be notified of new posts in 'Test post subject one' of 'Test social forum name'"
    And I should see "Subscribe to this social forum"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject two" "table_row"
    And I click on "You are not subscribed to this discussion. Click to subscribe." "link" in the "Test post subject one" "table_row"
    ...
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject two" "table_row"
    And I follow "Subscribe to this social forum"
    And I should see "Student One will be notified of new posts in 'Test social forum name'"
    And I should see "Unsubscribe from this social forum"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject two" "table_row"
    And I follow "Unsubscribe from this social forum"
    And I should see "Student One will NOT be notified of new posts in 'Test social forum name'"
    And I should see "Subscribe to this social forum"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject two" "table_row"

  Scenario: An automatic subscription social forum can have discussions unsubscribed from
    Given I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name        | Test social forum name |
      | Social Forum type        | Standard social forum for general use |
      | Description       | Test social forum description |
    ...
    And I follow "Course 1"
    And I follow "Test social forum name"
    Then I should see "Unsubscribe from this social forum"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject two" "table_row"
    And I click on "You are subscribed to this discussion. Click to unsubscribe." "link" in the "Test post subject one" "table_row"
    And I should see "Student One will NOT be notified of new posts in 'Test post subject one' of 'Test social forum name'"
  ...
  Scenario: A user does not lose their preferences when a social forum is switch from optional to automatic
    Given I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name        | Test social forum name |
      | Social Forum type        | Standard social forum for general use |
      | Description       | Test social forum description |
    ...
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject two" "table_row"
    When I follow "Unsubscribe from this social forum"
    Then I should see "Student One will NOT be notified of new posts in 'Test social forum name'"
    And I should see "Subscribe to this social forum"
    And "You are subscribed to this discussion. Click to unsubscribe." "link" should exist in the "Test post subject one" "table_row"
    And "You are not subscribed to this discussion. Click to subscribe." "link" should exist in the "Test post subject two" "table_row"
  ...
  Scenario: An optional social forum prompts a user to subscribe to a discussion when posting unless they have already chosen not to subscribe
    Given I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name        | Test social forum name |
      | Social Forum type        | Standard social forum for general use |
      | Description       | Test social forum description |
    ...
    And I follow "Test social forum name"
    And I should see "Subscribe to this social forum"
    And I reply "Test post subject one" post from "Test social forum name" social forum with:
      | Subject | Reply 1 to discussion 1 |
      | Message | Discussion contents 1, second message |
      | Discussion subscription | 1 |
    And I reply "Test post subject two" post from "Test social forum name" social forum with:
      | Subject | Reply 1 to discussion 1 |
      | Message | Discussion contents 1, second message |
  ...
  Scenario: An automatic social forum prompts a user to subscribe to a discussion when posting unless they have already chosen not to subscribe
    Given I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name        | Test social forum name |
      | Social Forum type        | Standard social forum for general use |
      | Description       | Test social forum description |
 ...
 Scenario: A user who is not logged in should not be able to subscribe to a discussion
   ...
   And I add a new discussion to "Test social forum name" social forum with:
     ...
     | Message | Test post message one |
   And I log out
   When I follow "Test social forum name"
   Then "You are not subscribed to this discussion. Click to subscribe." "link" should not exist in the "Test post subject one" "table_row"
   And "You are subscribed to this discussion. Click to unsubscribe." "link" should not exist in the "Test post subject one" "table_row"
   And I follow "Test post subject one"
   And "You are not subscribed to this discussion. Click to subscribe." "link" should not exist
