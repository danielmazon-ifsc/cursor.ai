@mod @mod_socialforum
Feature: Students can edit or delete their social forum posts within a set time limit
  In order to refine social forum posts
  As a user
  I need to edit or delete my social forum posts within a certain period of time after posting
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | socialforum      | Test social forum name        | Test social forum description  | C1      | socialforum     |
    And I log in as "student1"
    And I follow "Course 1"
    And I add a new discussion to "Test social forum name" social forum with:
      | Subject | Social Forum post subject |
      | Message | This is the body |

  Scenario: Edit social forum post
    Given I follow "Social Forum post subject"
    And I follow "Edit"
  ...
  Scenario: Delete social forum post
    Given I follow "Social Forum post subject"
    When I follow "Delete"
    And I press "Continue"
    Then I should not see "Social Forum post subject"
  ...
  Scenario: Time limit expires
    ...
    And I follow "Social Forum post subject"
