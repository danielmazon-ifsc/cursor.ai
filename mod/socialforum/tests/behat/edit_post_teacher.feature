@mod @mod_socialforum
Feature: Teachers can edit or delete any social forum post
  In order to refine the social forum contents
  As a teacher
  I need to edit or delete any user's social forum posts
  ...
  Background:
    ...
    And I follow "Course 1"
    And I reply "Teacher post subject" post from "Test social forum name" social forum with:
