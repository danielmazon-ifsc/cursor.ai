...
Feature: As a teacher I need to see an accurate list of subscribed users
  In order to see who is subscribed to a social forum
  As a teacher
  ...
  Scenario: A forced social forum does not allow to edit the subscribers
    When I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name        | Forced Social Forum 2 |
      | Social Forum type        | Standard social forum for general use |
      | Description       | Test social forum description |
      | Subscription mode | Forced subscription |
      | Visible           | Show |
    And I follow "Forced Social Forum 2"
    And I follow "Show/edit current subscribers"
  ...
  Scenario: A forced and hidden social forum lists only teachers
    When I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name        | Forced Social Forum 2 |
      | Social Forum type        | Standard social forum for general use |
      | Description       | Test social forum description |
  ...
  @javascript
  Scenario: An automatic social forum lists all subscribers
    When I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name        | Forced Social Forum 1 |
      | Social Forum type        | Standard social forum for general use |
      | Description       | Test social forum description |
