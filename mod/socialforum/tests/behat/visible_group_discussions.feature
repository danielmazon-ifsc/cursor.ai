...
Feature: Posting to all groups in a visible group discussion is restricted to users with access to all groups
  In order to post to all groups in a social forum with visible groups
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | socialforum      | Standard social forum name    | Standard social forum description    | C1     | groups       | 2         |
