@mod @mod_socialforum
Feature: A teacher can set one of 3 possible options for tracking read social forum posts
  In order to ease the social forum posts follow up
  As a user
  ...
  Scenario: Tracking social forum posts off
  ...
  Scenario: Tracking social forum posts optional with user tracking on
    Given I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name | Test social forum name |
      | Social Forum type | Standard social forum for general use |
      | Description | Test social forum description |
  ...
  Scenario: Tracking social forum posts optional with user tracking off
    Given I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name | Test social forum name |
      | Social Forum type | Standard social forum for general use |
      | Description | Test social forum description |
  ...
  Scenario: Tracking social forum posts forced with user tracking on
    Given the following config values are set as admin:
      | SOCIALFORUM_allowforcedreadtracking | 1 |
    And I am on site homepage
    And I follow "Course 1"
    Given I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name | Test social forum name |
  ...
  Scenario: Tracking social forum posts forced with user tracking off
    Given the following config values are set as admin:
      | SOCIALFORUM_allowforcedreadtracking | 1 |
    And I am on site homepage
    And I follow "Course 1"
  ...
  Scenario: Tracking social forum posts forced (with force disabled) with user tracking on
    Given the following config values are set as admin:
      | SOCIALFORUM_allowforcedreadtracking | 1 |
    And I am on site homepage
    And I follow "Course 1"
    ...
    And the following config values are set as admin:
      | SOCIALFORUM_allowforcedreadtracking | 0 |
    And I log out
    When I log in as "student1"
    And I follow "Course 1"
    Then I should see "1 unread post"
  ...
  Scenario: Tracking social forum posts forced (with force disabled) with user tracking off
    Given the following config values are set as admin:
      | SOCIALFORUM_allowforcedreadtracking | 1 |
    And I am on site homepage
    And I follow "Course 1"
