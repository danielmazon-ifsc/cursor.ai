...
Feature: A user can control their default discussion subscription settings
  ...
  Scenario: Creating a new discussion in an optional social forum follows user preferences
  ...
  Scenario: Replying to an existing discussion in an optional social forum follows user preferences
    Given I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name        | Test social forum name |
      | Social Forum type        | Standard social forum for general use |
      | Description       | Test social forum description |
  ...
  Scenario: Creating a new discussion in an automatic social forum follows social forum subscription
    Given I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name        | Test social forum name |
      | Social Forum type        | Standard social forum for general use |
      | Description       | Test social forum description |
  ...
  Scenario: Replying to an existing discussion in an automatic social forum follows social forum subscription
    Given I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name        | Test social forum name |
      | Social Forum type        | Standard social forum for general use |
      | Description       | Test social forum description |
  ...
  Scenario: Replying to an existing discussion in an automatic social forum which has been unsubscribed from follows user preferences
    Given I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name        | Test social forum name |
      | Social Forum type        | Standard social forum for general use |
      | Description       | Test social forum description |
    ...
    And I should see "Student One will NOT be notified of new posts in 'Test post subject' of 'Test social forum name'"
    And I follow "Test post subject"
    When I follow "Reply"
    And "input[name=discussionsubscribe][checked=checked]" "css_element" should exist
    And I log out
    ...
    And I follow "Test social forum name"
    And I click on "You are subscribed to this discussion. Click to unsubscribe." "link" in the "Test post subject" "table_row"
    And I should see "Student Two will NOT be notified of new posts in 'Test post subject' of 'Test social forum name'"
    And I follow "Test post subject"
    And I follow "Reply"
    And "input[name=discussionsubscribe]:not([checked=checked])" "css_element" should exist
