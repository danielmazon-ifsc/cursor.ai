...
Feature: Posting to all groups in a separate group discussion is restricted to users with access to all groups
  In order to post to all groups in a social forum with separate groups
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | socialforum      | Standard social forum name    | Standard social forum description    | C1     | sepgroups    | 1         |

  Scenario: Teacher with accessallgroups can view all groups
    Given I log in as "teacher1"
    And I follow "Course 1"
    When I follow "Standard social forum name"
  ...
  Scenario: Students can view all participants discussions in separate groups mode
    Given I log in as "teacher1"
    And I follow "Course 1"
    When I add a new discussion to "Standard social forum name" social forum with:
      | Subject | Social Forum post to all participants |
    ...
    And I follow "Course 1"
    And I follow "Standard social forum name"
    Then I should see "Social Forum post to all participants"
