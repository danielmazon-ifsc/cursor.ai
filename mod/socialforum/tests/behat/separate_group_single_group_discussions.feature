...
Feature: Posting to groups in a separate group discussion when restricted to groupings
  In order to post to groups in a social forum with separate groups and groupings
  As a teacher
  ...
  Background:
    ...
    And I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name  | Multiple groups social forum             |
      | Social Forum type  | Standard social forum for general use    |
      | Description | Standard social forum description        |
      | Group mode  | Separate groups                   |
      | Grouping    | G1                                |
    And I add a "Social Forum" to section "1" and I fill the form with:
      | Social Forum name  | Single groups social forum               |
      | Social Forum type  | Standard social forum for general use    |
      | Description | Standard social forum description        |
      | Group mode  | Separate groups                   |
      | Grouping    | G2                                |
  ...
  Scenario: Teacher with accessallgroups can post in all groups
    ...
    And I follow "Course 1"
    And I follow "Multiple groups social forum"
    ...
    And I follow "Course 1"
    And I follow "Single groups social forum"
