...
/**
 * Strings for component 'socialforum', language 'pt_br'
 *
...
$string['confirmsubscribediscussion'] = 'Você realmente quer se inscrever na discussão  \'{$a->discussion}\' no forum \'{$a->socialforum}\'?';
$string['confirmunsubscribe'] = 'Você deseja realmente cancelar assinatura do forum \'{$a}\'?';
$string['confirmunsubscribediscussion'] = 'Você realmente quer cancelar a inscrição do debate \'{$a->discussion}\' no forum \'{$a->socialforum}\'?';
...
$string['discussionmovedpost'] = 'Esta discussão foi transferida <a href="{$a->discusshref}">aqui</a> no fórum <a href="{$a->socialforumhref}">{$a->socialforumname}</a>';
$string['discussionname'] = 'Título';
$string['discussionnownotsubscribed'] = '{$a->name} não irá ser notificado de novos posts em \'{$a->name}\' de \'{$a->socialforum}\'';
$string['discussionnowsubscribed'] = '{$a->name} será notificado de novos posts em \'{$a->name}\' de \'{$a->socialforum}\'';
...
$string['emaildigestupdated'] = 'A opção de alerta por eamil foi alterada para \'{$a->maildigesttitle}\' para o fórum \'{$a->socialforum}\'. {$a->maildigestdescription}';
$string['emaildigestupdated_default'] = 'Sua configuração padrão \'{$a->maildigesttitle}\' foi usada para o fórum \'{$a->socialforum}\'. {$a->maildigestdescription}.';
...
$string['eventteacherpostreplied'] = 'Post criado';
...
$string['messageinboundfilecountexceeded'] = 'Não foi possível publicar sua resposta, já que inclui mais do que o número máximo de anexos permitidos para o fórum ({$a->socialforum-> maxattachments}).';
...
$string['messageinboundnopostforum'] = 'Não foi possível postar sua resposta, já que você não tem permissão para postar no fórum {$a->socialforum->name}.';
...
$string['modulename'] = 'Fórum Social';
...
$string['nownotsubscribed'] = '{$a->name} não receberá cópias de novos posts em \'{$a->socialforum}\' por e-mail';
$string['nownottracking'] = '{$a->name} não está mais monitorando \'{$a->socialforum}\'.';
$string['nowsubscribed'] = '{$a->name} receberá cópias de novas mensagens de  \'{$a->socialforum}\' via e-mail';
$string['nowtracking'] = '{$a->name} está monitorando \'{$a->socialforum}\'.';
...
$string['pluginname'] = 'Fórum Social';
...
$string['posttosocialforum'] = 'Publicar';
...
$string['allforums'] = 'Todos os fóruns';
$string['searchforumintro'] = 'Por favor digite os termos de busca em um ou mais dos seguintes campos:';
$string['searchwhichforums'] = 'Escolha em que fóruns buscar';
...
$string['smallmessage'] = '{$a->user} enviou mensagem em {$a->socialforumname}';
...
$string['unsubscribeallconfirm'] = 'Atualmente você está assinando {$a->socialforums} fóruns e {$a->discussions} discussões. Você realmente quer deixar de assinar todos os fóruns e discussões e desabilitar a assinatura automática?';
...
$string['unsubscribeallconfirmforums'] = 'Atualmente você está assinando  {$a->socialforums} fóruns. Você realmente quer deixar de assinar todos os fóruns e desativar a assinatura automática de discussão?';
...
// Vote strings
$string['relevant'] = 'Relevante';
$string['relevancy'] = 'Relevância';
$string['irrelevant'] = 'Irrelevante';

// Vote events
$string['eventdiscussionrelevancyvoted'] = 'Usuário votou em uma discussão como relevante';
$string['eventdiscussionrelevancyvotecancelled'] = "Cancelado o voto do usuário na relevância de uma discussão";
$string['eventdiscussionvotedrelevant'] = "Discussão do usuário votada como relevante";
$string['eventdiscussionvotedirrelevant'] = "Discussão do usuário votada como irrelevante";
$string['eventpostrelevancyvoted'] = 'Usuário votou em uma postagem como relevante';
$string['eventpostrelevancyvotecancelled'] = "Cancelado o voto do usuário na relevância de uma postagem";
$string['eventpostvotedrelevant'] = "Postagem do usuário votada como relevante";
$string['eventpostvotedirrelevant'] = "Postagem do usuário votada como irrelevante";
$string['eventpostvotedmostrelevant'] = "Postagem do usuário votada como a mais relevante";
$string['eventpostnolongermostrelevant'] = "Postagem do usuário deixou de ser a mais relevante";

$string['unmarkasimproper'] = 'Conteúdo marcado como impróprio. Clique para desmarcar';
$string['markasimproper'] = 'Clique para marcar conteúdo como impróprio';
$string['eventpostmarkedimproper'] = 'Usuário marcou uma postagem como conteúdo impróprio';
$string['eventpostunmarkedimproper'] = 'Usuário desmarcou uma postagem como conteúdo impróprio';
$string['lastreply'] = 'Último comentário';
$string['related'] = 'Relacionado';
$string['relateddesc'] = 'As pessoas que particiam desta discussão estão falando sobre este vídeo relacionado.';
$string['topics'] = 'Tópicos';
$string['topic'] = 'Tópico';
$string['beforeposting'] = 'Antes de você postar';
$string['beforepostingtext'] = 'Pode haver outros alunos que já tenham feito a mesma pergunta antes.<br>Faça uma pesquisa rápida primeiro para ter certeza de que sua pergunta é única.';
$string['searchinforum'] = 'Buscar no fórum';
