...
/**
 * The mod_socialforum post marked as improper.
 *
...
/**
 * The mod_socialforum post marked as improper event class.
 *
 * @package    mod_socialforum
 * @copyright 2016 Viddia (http://viddia.com.br)
 * @author    Ricardo Drummond
 */
class post_markedimproper extends \core\event\base {
    ...
    public function get_description() {
        return 'The user with id ' . $this->userid . ' marked post id '
    ...
    public static function get_name() {
        return get_string('eventpostmarkedimproper', 'mod_socialforum');
    }
