...
/**
 * The mod_socialforum post voted as irrelevant event.
 *
...
/**
 * The mod_socialforum post voted as irrelevant event class.
 *
 * @package    mod_socialforum
 * @copyright 2016 Viddia (http://viddia.com.br)
 * @author    Ricardo Drummond
 */
class post_votedirrelevant extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostvotedirrelevant', 'mod_socialforum');
    }
