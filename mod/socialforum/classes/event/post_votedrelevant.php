...
/**
 * The mod_socialforum post voted as relevant.
 *
...
/**
 * The mod_socialforum post voted as relevant event class.
 *
 * @package    mod_socialforum
 * @copyright 2016 Viddia (http://viddia.com.br)
 * @author    Ricardo Drummond
 */
class post_votedrelevant extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostvotedrelevant', 'mod_socialforum');
    }
