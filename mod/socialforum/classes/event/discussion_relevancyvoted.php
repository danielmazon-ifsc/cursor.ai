...
/**
 * The mod_socialforum discussion relevancy voted event.
 *
...
/**
 * The mod_socialforum discussion relevancy voted event class.
 *
 * @package    mod_socialforum
 * @copyright 2016 Viddia (http://viddia.com.br)
 * @author    Ricardo Drummond
 */
class discussion_relevancyvoted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventdiscussionrelevancyvoted', 'mod_socialforum');
    }
