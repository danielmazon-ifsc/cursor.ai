...
/**
 * The mod_socialforum discussion voted as irrelevant event.
 *
...
/**
 * The mod_socialforum discussion voted as irrelevant event class.
 *
 * @package    mod_socialforum
 * @copyright 2016 Viddia (http://viddia.com.br)
 * @author    Ricardo Drummond
 */
class discussion_votedirrelevant extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id ' . $this->userid . ' voted discussion id "
                . $this->objectid . " and it has become irrelevant";
    }
    ...
    public static function get_name() {
        return get_string('eventdiscussionvotedirrelevant', 'mod_socialforum');
    }
