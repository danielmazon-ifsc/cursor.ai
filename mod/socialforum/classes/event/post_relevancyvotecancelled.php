...
/**
 * The mod_socialforum post relevancy vote cancelled event.
 *
...
/**
 * The mod_socialforum post relevancy vote cancelled event class.
 *
 * @package    mod_socialforum
 * @copyright 2016 Viddia (http://viddia.com.br)
 * @author    Ricardo Drummond
 */
class post_relevancyvotecancelled extends \core\event\base {
    ...
    public function get_description() {
        return 'The user with id ' . $this->userid . ' vote in post id '
                . $this->objectid . ' as relevant has been cancellled';
    }
    ...
    public static function get_name() {
        return get_string('eventpostrelevancyvotecancelled', 'mod_socialforum');
    }
