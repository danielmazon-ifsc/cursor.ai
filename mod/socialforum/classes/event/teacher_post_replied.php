...
/**
 * The mod_socialforum teacher post replied event.
 *
...
/**
 * The mod_socialforum teacher post replied event class.
 *
 ...
 * @author    Ricardo Drummond
 */
class teacher_post_replied extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has replied the teacher post with id '$this->objectid' in the discussion with " .
    ...
    public static function get_name() {
        return get_string('eventteacherpostreplied', 'mod_socialforum');
    }
