...
/**
 * The mod_socialforum post updated event.
 *
...
/**
 * The mod_socialforum post updated event class.
 *
...
class post_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostupdated', 'mod_socialforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'socialforum', 'update post', $logurl, $this->objectid, $this->contextinstanceid);
    }
