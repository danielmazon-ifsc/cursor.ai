...
/**
 * The mod_socialforum post voted as the most relevant event.
 *
...
/**
 * The mod_socialforum post voted as the most relevant event class.
 *
 * @package    mod_socialforum
 * @copyright 2016 Viddia (http://viddia.com.br)
 * @author    Ricardo Drummond
 */
class post_votedmostrelevant extends \core\event\base {
    ...
    public function get_description() {
        return 'The user with id ' . $this->userid . ' voted post id '
                . $this->objectid . ' and it has become the most relevant';
    }
    ...
    public static function get_name() {
        return get_string('eventpostvotedmostrelevant', 'mod_socialforum');
    }
