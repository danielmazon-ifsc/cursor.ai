...
/**
 * The mod_socialforum post deleted event.
 *
...
/**
 * The mod_socialforum post deleted event class.
 *
...
class post_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpostdeleted', 'mod_socialforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'socialforum', 'delete post', $logurl, $this->objectid, $this->contextinstanceid);
    }
