...
/**
 * The mod_socialforum discussion pinned event.
 *
...
class discussion_pinned extends \core\event\base {
    ...
    public function get_description() {
        return "The user {$this->userid} has pinned the discussion {$this->objectid} in the socialforum {$this->other['socialforumid']}";
    }
    ...
    public static function get_name() {
        return get_string('eventdiscussionpinned', 'mod_socialforum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'socialforum', 'pin discussion', $logurl, $this->objectid, $this->contextinstanceid);
    }
