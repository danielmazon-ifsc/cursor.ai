...
/**
 * The mod_socialforum discussion deleted event.
 *
...
/**
 * The mod_socialforum discussion deleted event class.
 *
...
class discussion_deleted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has deleted the discussion with id '$this->objectid' in the socialforum " .
    ...
    public static function get_name() {
        return get_string('eventdiscussiondeleted', 'mod_socialforum');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/socialforum/view.php', array('id' => $this->contextinstanceid));
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'socialforum', 'delete discussion', 'view.php?id=' . $this->contextinstanceid,
