...
namespace mod_socialforum\output;
 ...
 */
class socialforum_post implements \renderable, \templatable {

    /**
     * The course that the socialforum post is in.
     *
     * @var object $course
     */
    ...
    /**
     * The course module for the socialforum.
     *
     * @var object $cm
     */
    protected $cm = null;
    ...
    /**
     * The socialforum that the post is in.
     *
     * @var object $socialforum
     */
    protected $socialforum = null;

    /**
     * The discussion that the socialforum post is in.
     *
    ...
    /**
     * The socialforum post being displayed.
     *
     * @var object $post
     */
    protected $post = null;
    ...
    /**
     * Whether to override socialforum display when displaying usernames.
    ...
    /**
     * Builds a renderable socialforum post
     *
     * @param object $course Course of the socialforum
     * @param object $cm Course Module of the socialforum
     * @param object $socialforum The socialforum of the post
     ...
     */
    public function __construct($course, $cm, $socialforum, $discussion, $post, $author, $recipient, $canreply) {
        $this->course = $course;
        $this->cm = $cm;
        $this->socialforum = $socialforum;
     ...
     *
     * @param \mod_socialforum_renderer $renderer The render to be used for formatting the message and attachments
     ...
     * @return stdClass Data ready for use in a mustache template
     */
    protected function export_for_template_text(\mod_socialforum_renderer $renderer) {
        return array(
            ...
            'socialforumname' => html_entity_decode($this->get_socialforumname()),
            ...
            'unsubscribesocialforumlink' => $this->get_unsubscribesocialforumlink(),
            'parentpostlink' => $this->get_parentpostlink(),
            'socialforumindexlink' => $this->get_socialforumindexlink(),
            'socialforumviewlink' => $this->get_socialforumviewlink(),
     ...
     * @return stdClass Data ready for use in a mustache template
     */
    protected function export_for_template_html(\mod_socialforum_renderer $renderer) {
        return array(
            'id' => $this->post->id,
            'coursename' => $this->get_coursename(),
            'courselink' => $this->get_courselink(),
            'socialforumname' => $this->get_socialforumname(),
    ...
    /**
     * Get the link to the socialforum index for this course.
     *
     * @return string
     */
    public function get_socialforumindexlink() {
        $link = new \moodle_url(
                // Posts are viewed on the topic.
                '/mod/socialforum/index.php', array(
            'id' => $this->course->id,
                )
        );
    ...
    /**
     * Get the link to the view page for this socialforum.
     *
     * @return string
     */
    public function get_socialforumviewlink() {
        $link = new \moodle_url(
                // Posts are viewed on the topic.
                '/mod/socialforum/view.php', array(
            'f' => $this->socialforum->id,
                )
        );
    ...
    protected function _get_discussionlink() {
        return new \moodle_url(
                // Posts are viewed on the topic.
                '/mod/socialforum/discuss.php', array(
            // Within a discussion.
    ...
    /**
     * Get the link to unsubscribe from the socialforum.
     *
     * @return string
     */
    public function get_unsubscribesocialforumlink() {
        $link = new \moodle_url(
                '/mod/socialforum/subscribe.php', array(
            'id' => $this->socialforum->id,
                )
        );
    ...
    public function get_replylink() {
        return new \moodle_url(
                '/mod/socialforum/post.php', array(
            'reply' => $this->post->id,
                )
        );
    }
    ...
    /**
     * ID number of the course that the socialforum is in.
     *
     * @return string
     */
    ...
    /**
     * The full name of the course that the socialforum is in.
     *
     * @return string
     */
    ...
    /**
     * The name of the course that the socialforum is in.
     *
     * @return string
     */
    ...
    /**
     * The name of the socialforum.
     *
     * @return string
     */
    public function get_socialforumname() {
        return format_string($this->socialforum->name, true);
    }
     ...
     * If the socialforum name matches the discussion name, the discussion name
     * is not typically displayed.
     *
     * @return boolean
     */
    public function get_showdiscussionname() {
        return ($this->socialforum->name !== $this->discussion->name);
    }
    ...
    public function get_postdate() {
        ...
        if (!empty($CFG->socialforum_enabletimedposts) && ($this->discussion->timestart > $postmodified)) {
    ...
    public function get_group_picture() {
        if (isset($this->userfrom->groups)) {
            $groups = $this->userfrom->groups[$this->socialforum->id];
        } else {
