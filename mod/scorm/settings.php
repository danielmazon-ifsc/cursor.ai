...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect_with_advanced('scorm/displayattemptstatus', get_string('displayattemptstatus', 'scorm'), get_string('displayattemptstatusdesc', 'scorm'), array('value' => 1, 'adv' => false), scorm_get_attemptstatus_array()));
    ...
    $settings->add(new admin_setting_configselect('scorm/forcenewattempt', get_string('forcenewattempts', 'scorm'), get_string('forcenewattempts_help', 'scorm'), 0, $forceattempts));
    ...
    $settings->add(new admin_setting_configcheckbox('scorm/scormstandard', get_string('scormstandard', 'scorm'), get_string('scormstandarddesc', 'scorm'), 0));
