...
class mod_scorm_mod_form extends moodleform_mod {
    ...
    public function data_preprocessing(&$defaultvalues) {
        ...
        if (isset($defaultvalues['width']) && (strpos($defaultvalues['width'], '%') === false) && ($defaultvalues['width'] <= 100)) {
            $defaultvalues['width'] .= '%';
        }
        if (isset($defaultvalues['height']) && (strpos($defaultvalues['height'], '%') === false) && ($defaultvalues['height'] <= 100)) {
        ...
        file_prepare_draft_area($draftitemid, $this->context->id, 'mod_scorm', 'package', 0, array('subdirs' => 0, 'maxfiles' => 1));
    ...
    public function set_data($defaultvalues) {
        ...
        $defaultvalues['completionstatusallscos'] = 1;
