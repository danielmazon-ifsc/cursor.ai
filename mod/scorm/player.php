...
if (empty($scorm->popup) || $displaymode == 'popup') {
    if ($course->format == 'singleactivity' && $scorm->skipview == SCORM_SKIPVIEW_ALWAYS && !has_capability('mod/scorm:viewreport', context_module::instance($cm->id))) {
...
$class = $CFG->theme == 'pdi' ? 'narrow-page' : '';
echo html_writer::start_div('', array(
    'id' => 'tocbox',
    'class' => $class
));
...
if ($CFG->theme == "pdi") {
    echo scorm_print_scorm_details($scorm, $cm);
}
