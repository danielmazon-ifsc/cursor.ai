...
\core_privacy\local\metadata\provider, \core_privacy\local\request\user_preference_provider {
    ...
    public static function get_metadata(collection $collection): collection {
        ...
        $collection->add_user_preference(
                'scorm_report_interactions_qtext', 'privacy:metadata:preference:scorm_report_interactions_qtext'
        );
        $collection->add_user_preference(
                'scorm_report_interactions_resp', 'privacy:metadata:preference:scorm_report_interactions_resp'
        );
        $collection->add_user_preference(
                'scorm_report_interactions_right', 'privacy:metadata:preference:scorm_report_interactions_right'
        );
        $collection->add_user_preference(
                'scorm_report_interactions_result', 'privacy:metadata:preference:scorm_report_interactions_result'
        );
    ...
    protected static function get_and_export_user_preference(int $userid, string $userpreference, $transform = false) {
        ...
        if ($prefvalue !== null) {
            ...
            writer::export_user_preference(
                    'scormreport_interactions', $userpreference, $transformedvalue, get_string('privacy:metadata:preference:' . $userpreference, 'scormreport_interactions')
            );
        }
    }
