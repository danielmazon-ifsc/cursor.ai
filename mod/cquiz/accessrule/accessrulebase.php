...
/**
 * Base class for rules that restrict the ability to attempt a cquiz.
 *
 * @package   mod_cquiz
...
/**
 * A base class that defines the interface for the various cquiz access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class cquiz_access_rule_base {

    /** @var stdClass the cquiz settings. */
    protected $cquiz;

    /** @var cquiz the cquiz object. */
    protected $cquizobj;
    ...
    /**
     * Create an instance of this rule for a particular cquiz.
     * @param cquiz $cquizobj information about the cquiz in question.
     * @param int $timenow the time that should be considered as 'now'.
     */
    public function __construct($cquizobj, $timenow) {
        $this->cquizobj = $cquizobj;
        $this->cquiz = $cquizobj->get_cquiz();
        $this->timenow = $timenow;
    }

    /**
     * Return an appropriately configured instance of this rule, if it is applicable
     * to the given cquiz, otherwise return null.
     * @param cquiz $cquizobj information about the cquiz in question.
     * @param int $timenow the time that should be considered as 'now'.
     * @param bool $canignoretimelimits whether the current user is exempt from
     *      time limits by the mod/cquiz:ignoretimelimits capability.
     * @return cquiz_access_rule_base|null the rule, if applicable, else null.
     */
     ...
     *
     * @param mod_cquiz_preflight_check_form $cquizform the form being built.
    ...
    /**
     * This is called when the current attempt at the cquiz is finished. This is
    ...
    /**
     * Information, such as might be shown on the cquiz view page, relating to this restriction.
     ...
     * this cquiz, then return true. This is used so we can know whether to display a
    ...
    /**
     * Add any fields that this rule requires to the cquiz settings form. This
     * method is called from {@link mod_cquiz_mod_form::definition()}, while the
    ...
    /**
     * Save any submitted settings when the cquiz settings form is submitted. This
     * is called from {@link cquiz_after_add_or_update()} in lib.php.
    ...
    /**
     * Delete any rule-specific settings when the cquiz is deleted. This is called
     * from {@link cquiz_delete_instance()} in lib.php.
     ...
     * here is probalby to read the code of {@link cquiz_access_manager::load_settings()}.
     *
     * If you have some settings that cannot be loaded in this way, then you can
     * use the {@link get_extra_settings()} method instead, but that has
     * performance implications.
     *
     * @param int $cquizid the id of the cquiz we are loading settings for. This
     *     can also be accessed as cquiz.id in the SQL. (cquiz is a table alisas for {cquiz}.)
     ...
     */
    public static function get_settings_sql($cquizid) {
        return array('', '', array());
    }
     ...
     */
    public static function get_extra_settings($cquizid) {
        return array();
    }
