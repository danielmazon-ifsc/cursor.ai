@mod @mod_cquiz
Feature: Allow students to redo questions in a practice cquiz, without starting a whole new attempt
  In order to practice particular skills I am struggling with
  As a student
  I need to be able to redo each question in a cquiz as often as necessary without starting a whole new attempt, if my teacher allows it.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | cquiz       | Cquiz 1 | Cquiz 1 description | C1     | cquiz1    | immediatefeedback  | 1                |
  ...
  Scenario: Teachers reviewing can see all the qestions attempted in a slot
    ...
    And I navigate to "Statistics" node in "Competency Quiz administration > Results"
    And I follow "TF1"
    And "False" row "Frequency" column of "cquizresponseanalysis" table should contain "100.00%"
    And "True" row "Frequency" column of "cquizresponseanalysis" table should contain "0.00%"
    And "[No response]" row "Frequency" column of "cquizresponseanalysis" table should contain "100.00%"
