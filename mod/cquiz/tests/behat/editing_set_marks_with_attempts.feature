@mod @mod_cquiz
Feature: In order to create a cquiz that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit competency quiz page (even after the cquiz has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | cquiz       | Cquiz 1 | C1     | cquiz1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I follow "Course 1"
    And I add a "True/False" question to the "Cquiz 1" cquiz with:
  ...
  @javascript
  Scenario: Set the max mark in cquiz for a question.
    When I set the max mark in cquiz for question "First question" to "7.0"
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the cquiz settings say it should be.
