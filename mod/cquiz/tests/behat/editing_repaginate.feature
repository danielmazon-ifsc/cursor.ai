@mod @mod_cquiz
Feature: Edit competency quiz page - pagination
  In order to build a cquiz laid out in pages the way I want
  As a teacher
  ...
  Scenario: Repaginate questions with N question(s) per page as well as clicking
    ...
    When I click on the "Add" page break icon after cquiz question "Essay 01 new"
    And I should see "Essay 01 new" on cquiz page "1"
    And I should see "Essay 02 new" on cquiz page "2"

    When I click on the "Remove" page break icon after cquiz question "Essay 01 new"
    And I should see "Essay 01 new" on cquiz page "1"
    And I should see "Essay 02 new" on cquiz page "1"
    And I should not see "Page 2"
    ...
    When I click on the "Add" page break icon after cquiz question "Essay 02 new"
    And I should see "Essay 01 new" on cquiz page "1"
    And I should see "Essay 02 new" on cquiz page "1"
    ...
    And I should see "Essay 01 new" on cquiz page "1"
    And I should see "Essay 02 new" on cquiz page "2"
    And I should see "Essay 03 new" on cquiz page "3"

    When I click on the "Remove" page break icon after cquiz question "Essay 02 new"
    And I should see "Essay 01 new" on cquiz page "1"
    And I should see "Essay 02 new" on cquiz page "2"
    And I should see "Essay 03 new" on cquiz page "2"
    And I should not see "Page 3"
    ...
    And I press "Go"
    Then I should see "Essay 01 new" on cquiz page "1"
    And I should see "Essay 02 new" on cquiz page "2"
    And I should see "Essay 03 new" on cquiz page "3"

    # Add the forth Essay question in a new page (Page 4).
    When I open the "Page 3" add to cquiz menu
    ...
    And I should see "Essay 02 new" on cquiz page "2"
    And I should see "Essay 03 new" on cquiz page "3"
    And I should see "Essay 04 new" on cquiz page "3"

    When I click on the "Add" page break icon after cquiz question "Essay 03 new"
    And I should see "Essay 01 new" on cquiz page "1"
    And I should see "Essay 02 new" on cquiz page "2"
    And I should see "Essay 03 new" on cquiz page "3"
    And I should see "Essay 04 new" on cquiz page "4"
