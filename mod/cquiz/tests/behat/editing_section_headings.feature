@mod @mod_cquiz
Feature: Edit competency quiz page - section headings
  In order to build a cquiz laid out in sections the way I want
  As a teacher
  ...
  @javascript
  Scenario: We have a cquiz with one default section
  ...
  Scenario: Modify the default section headings
    ...
    And I follow "Cquiz 1"
    And I follow "Edit competency quiz"
    And I change cquiz section heading "" to "This is section one"
 ...
 @javascript
  Scenario: Modify section headings
    ...
    And cquiz "Cquiz 1" contains the following questions:
      ...
      | TF3      | 3    |
      | TF4      | 3    |
    And cquiz "Cquiz 1" contains the following sections:
    ...
    And I follow "Edit competency quiz"
    And I change cquiz section heading "" to "This is section one"
    And I change cquiz section heading "Heading 2" to "This is section two"
    Then I should see "This is section one"
  ...
  Scenario: The edit-icon tool-tips are updated when a section is edited
    ...
    And I follow "Cquiz 1"
    And I follow "Edit competency quiz"
    And I change cquiz section heading "Heading 2" to "Edited heading"
  ...
  Scenario: Moving a question up from section 3 to the first section.
    ...
    And I follow "Cquiz 1"
    And I follow "Edit competency quiz"
    And I move "TF5" to "After Question 2" in the cquiz by clicking the move icon
    Then I should see "TF5" on cquiz page "2"
  ...
  Scenario: moving a question down from the first section to the second section.
    ...
    And I follow "Cquiz 1"
    And I follow "Edit competency quiz"
    And I move "TF1" to "After Question 3" in the cquiz by clicking the move icon
    Then I should see "TF1" on cquiz page "2"

  @javascript
  Scenario: I should not see a delete icon for the first section in the cquiz.
    Given the following "activities" exist:
      | activity   | name   | intro              | course | idnumber |
      | cquiz       | Cquiz 1 | Cquiz 1 description | C1     | cquiz1    |
    And the following "questions" exist:
  ...
  Scenario: Turn shuffling on for a section
    ...
    And I follow "Cquiz 1"
    And I follow "Edit competency quiz"
    And I click on shuffle for section "Heading 1" on the cquiz edit page
    And I click on shuffle for section "Heading 2" on the cquiz edit page
    Then shuffle for section "Heading 1" should be "On" on the cquiz edit page
    And shuffle for section "Heading 2" should be "On" on the cquiz edit page
  ...
  Scenario: Turn shuffling off for a section
    ...
    And I click on shuffle for section "Heading 1" on the cquiz edit page
    And I click on shuffle for section "Heading 2" on the cquiz edit page
    Then shuffle for section "Heading 1" should be "Off" on the cquiz edit page
    And shuffle for section "Heading 2" should be "Off" on the cquiz edit page
    And I reload the page
    And shuffle for section "Heading 1" should be "Off" on the cquiz edit page
    And shuffle for section "Heading 2" should be "Off" on the cquiz edit page
  ...
  Scenario: Add section heading option only appears for pages that are not the first in their section.
    ...
    And I follow "Cquiz 1"
    And I follow "Edit competency quiz"
    And I click on the "Add" page break icon after cquiz question "TF1"
  ...
  Scenario: Verify sections are added in the right place afte ajax changes
    ...
    And I follow "Cquiz 1"
    And I follow "Edit competency quiz"
    And I click on the "Remove" page break icon after cquiz question "TF1"
    And I open the "Page 2" add to cquiz menu
    And I follow "a new section heading" in the cquiz open menu
