...
/**
 * The mod_cquiz attempt deleted event.
 *
 * @package    mod_cquiz
...
/**
 * The mod_cquiz attempt deleted event class.
 *
...
class attempt_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptdeleted', 'mod_cquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the attempt with id '$this->objectid' belonging to the cquiz " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'cquiz', 'delete attempt', 'report.php?id=' . $this->contextinstanceid,
