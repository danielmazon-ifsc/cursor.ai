...
/**
 * The mod_cquiz attempt became overdue event.
 *
 * @package    mod_cquiz
...
/**
 * The mod_cquiz attempt became overdue event class.
 *
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The cquiz attempt with id '$this->objectid' belonging to the cquiz with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventcquizattempttimelimitexceeded', 'mod_cquiz');
    }
