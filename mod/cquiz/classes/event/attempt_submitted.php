...
/**
 * The mod_cquiz attempt submitted event.
 *
 * @package    mod_cquiz
...
/**
 * The mod_cquiz attempt submitted event class.
 *
...
class attempt_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcquizattemptsubmitted', 'mod_cquiz');
    }
    ...
    static public function get_legacy_eventname() {
        return 'cquiz_attempt_submitted';
    }
