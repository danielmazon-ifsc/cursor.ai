...
/**
 * The mod_cquiz attempt reviewed event.
 *
 * @package    mod_cquiz
...
/**
 * The mod_cquiz attempt reviewed event class.
 *
...
class attempt_reviewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptreviewed', 'mod_cquiz');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'cquiz', 'review', 'review.php?attempt=' . $this->objectid,
