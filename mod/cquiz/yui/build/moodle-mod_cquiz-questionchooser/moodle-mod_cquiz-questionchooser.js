YUI.add('moodle-mod_cquiz-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_cquiz-questionchooser'
});

M.mod_cquiz = M.mod_cquiz || {};
M.mod_cquiz.init_questionchooser = function() {
    M.mod_cquiz.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_cquiz.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_cquiz-util", "querystring-parse"]});
