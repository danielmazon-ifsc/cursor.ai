YUI.add('moodle-mod_cquiz-cquizbase', function (Y, NAME) {

/**
 * The cquizbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_cquiz-cquizbase
 */
var CQUIZBASENAME = 'mod_cquiz-cquizbase';

var CQUIZBASE = function() {
    CQUIZBASE.superclass.constructor.apply(this, arguments);
};
...
M.mod_cquiz.cquizbase = M.mod_cquiz.cquizbase || new CQUIZBASE();

// Abstract functions that needs to be defined per format (course/format/somename/format.js)
M.mod_cquiz.edit = M.mod_cquiz.edit || {};
 ...
 */
M.mod_cquiz.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_cquiz.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
