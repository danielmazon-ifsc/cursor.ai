...
/**
 * Strings for component 'cquiz', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_cquiz
...
';
$string['action'] = 'Ação';
$string['activityoverview'] = 'Você tem avaliações pendentes';
$string['adaptive'] = 'Modo adaptativo';
$string['adaptive_help'] = 'Se ativado, várias respostas a uma questão são permitidas em uma mesma tentativa da avaliação. Por exemplo, se uma resposta está marcada como incorreta, será permitido ao estudante tentar novamente. No entanto, dependendo da definicção de "Aplicar sanções", geralmente serão subtraídos pontos para cada tentativa errada.
';
$string['add'] = 'Adicionar';
$string['addaquestion'] = 'uma nova questão';
$string['addarandomquestion'] = 'uma questão aleatória';
$string['addarandomquestion_help'] = 'Quando uma questão aleatória é adicionada, isso resulta em uma questão escolhida aleatoriamente a partir da categoria que está sendo inserida na avaliação. Isto significa que diferentes alunos poderão receber uma seleção diferente de questões, e quando uma avaliação permite várias tentativas, para cada uma delas é possível conter uma nova seleção de questões.
';
...
$string['addingquestions'] = 'Neste lado da página você administra a sua base de dados de questões. As questões são organizadas em categorias e podem ser usadas por qualquer avaliação deste curso ou de outros cursos.
<br /><br />Depois de selecionar ou criar uma categoria você poderá criar ou editar questões. Você pode selecionar qualquer destas questões para adicionar ao sua avaliação que se encontra no outro lado desta página.';
...
$string['addquestions'] = 'Acrescentar questões';
$string['addquestionstocquiz'] = 'Acrescentar questões a esta avaliação';
...
$string['addrandomquestion'] = 'Adiconar questões aleatórias';
$string['addrandomquestionatend'] = 'Adicionar uma questão aleatória no final';
$string['addrandomquestiontopage'] = 'Adicionar uma questão aleatória para página {$a}';
$string['addrandomquestiontocquiz'] = 'Adicionar uma questão aleatória à avaliação {$a}';
$string['addselectedquestionstocquiz'] = 'Adicionar questões selecionadas para a avaliação';
$string['addselectedtocquiz'] = 'Acrescentar as seleções aa avaliação';
$string['addtocquiz'] = 'Acrescentar à avaliação';
$string['affectedstudents'] = 'Atingidos {$a}';
$string['aftereachquestion'] = 'Após adicionada cada questão';
...
$string['attempterror'] = 'Você não tem permissão de tentar esta avaliação neste momento porque: {$a}';
...
$string['attemptcquiznow'] = 'Iniciar Avaliação';
$string['attempts'] = 'Tentativas';
$string['attemptsallowed'] = '{$a} tentativas são permitidas';
$string['attemptsdeleted'] = 'Excluir tentativas da avaliação';
$string['attemptselection'] = 'Selecionar as tentativas a serem analisadas em relação aos usuários:';
$string['attemptsexist'] = 'Esta avaliação já foi respondida';
...
$string['autosaveperiod_desc'] = 'As respostas dos alunos podem ser salvas automaticamente a cada minuto, durante as tentativas da avaliação. Trata-se de um trade-off: salvar as respostas aumenta a carga do servidor, mas reduz a chance dos alunos perdem o seu trabalho.';
...
$string['backtocquiz'] = 'Voltar para edição da avaliação';
$string['basicideasofcquiz'] = 'As ideias básicas da construção da avaliação';
...
* A avaliação aparece em uma janela <em>pop-up</em> em tela cheia, que abrange todas as outras janelas e não tem controles de navegação
...
$string['cannoteditafterattempts'] = 'Você não pode adicionar ou remover questões, porque já foram registradas tentativas. ({$a})';
...
$string['cannotsetgrade'] = 'Não foi possível definir nova nota máxima para avaliação';
$string['cannotsetsumgrades'] = 'Falhou ao definir sumgrades';
$string['cannotstartgradesmismatch'] = 'Você não pode iniciar uma tentativa nesta avaliação. A avaliação está configurado para ser avaliada com nota {$a->grade}, mas nenhuma das questões valem nota. Isso pode ser arrumado na página \'Editar avaliação".';
$string['cannotstartmissingquestion'] = 'Não foi possivel iniciar tentativa para essa avaliação.  As definições da avaliação incluem uma questão que não existe.';
$string['cannotstartnoquestions'] = 'Não é possível iniciar uma tentativa nesta avaliação. A avaliação não foi configurada ainda. Nenhuma questão foi adicionada.';
...
$string['closebeforeopen'] = 'Não foi possível atualizar a avaliação. A data final é muito próxima à data de abertura.';
...
$string['completionattemptsexhausted_help'] = 'Marcar avaliação como completa quando o aluno tiver esgotado o número máximo de tentativas.';
...
$string['configadaptive'] = 'Se você escolher \'Sim\' para esta opção, então   será permitido ao estudante a utilização de múltiplas respostas a uma questão até mesmo em uma mesma tentativa da avaliação.
';
$string['configattemptsallowed'] = 'Restrições no número de tentativas que estudantes tem permissão na avaliação.';
$string['configdecimaldigits'] = 'Número de dígitos que devem ser mostrados após o ponto decimal ao exibir notas.';
$string['configdecimalplaces'] = 'Quantidade de dígitos que devem ser mostrados após o ponto decimal ao exibir a pontuação para a avaliação. ';
$string['configdecimalplacesquestion'] = 'Quantidade de dígitos que devem ser mostrados após o ponto decimal ao exibir a série para as questões individuais.
';
...
$string['configgrademethod'] = 'Quando são permitidas múltiplas tentativas, qual método deve ser utilizado para calcular a nota final do aluno para a avaliação.';
$string['configintro'] = 'Os valores que você definir aqui determina os valores padrões que são utilizados nas configurações de formulário quando você cria um nova avaliação. Você também pode definir as configurações avançadas.';
$string['configmaximumgrade'] = 'A nota máxima desta avaliação.';
$string['confignavmethod'] = 'Usando navegação Livre, as questões pode ser respondidas em qualquer ordem usando a navegação.';
$string['confignewpageevery'] = 'Quando se adicionarem questões na avaliação quebras de página serão inserida automaticamente conforme a configuração aqui escolhida.';
...
$string['configpopup'] = 'Força a tentativa de abrir em uma janela <em>pop-up</em>, e usar truques do JavaScript  para tentar restringir a copiar e colar, etc. durante as tentativas da avaliação.';
$string['configrequirepassword'] = 'Os estudantes devem digitar essa senha antes que eles possam tentar responder a avaliação.';
$string['configrequiresubnet'] = 'Os estudantes podem tentar responder a avaliação apenas a partir desses computadores.';
$string['configreviewoptions'] = 'Estas opções controlam que informações os usuários podem ver ao rever uma tentativa da avaliação ou ver nos relatórios.';
...
$string['configshufflewithin'] = 'Se você habilitar esta opção, então as partes que compõem cada uma das questões será mudada aleatoriamente toda vez que um estudante iniciar uma tentativa na avaliação, desde que a opção também esteja ativada nas configurações da avaliação.';
$string['configtimelimit'] = 'Limite de tempo padrão para testes em poucos minutos. 0 significa sem limite de tempo.';
$string['configtimelimitsec'] = 'Limite padrão de tempo para avaliação em segundos. \'Zero\' significa que não há limite de tempo. ';
...
$string['continueattemptcquiz'] = 'Continuar a última tentativa';
...
$string['countdownfinished'] = 'O prazo para o envio dos resultados da avaliação terminou, envie as suas respostas agora.';
$string['countdowntenminutes'] = 'O prazo para o envio dos resultados da avaliação vai acabar daqui a 10 minutos.';
...
$string['createmultiple'] = 'Criar questões múltiplas';
$string['createnewquestion'] = 'Criar nova questão';
$string['createquestionandadd'] = 'Criar uma nova questão e adicioná-la aa avaliação.';
...
$string['decimalplacesquestion'] = 'Casas decimais nas avaliações da questão';
$string['decimalplacesquestion_help'] = 'Esta configuração especifica a quantidade de dígitos mostrados após o ponto decimal ao exibir as avaliações para as questões individuais.';
...
$string['downloadextra'] = '(o arquivo pode ser encontrado também na pasta /avaliação da seção arquivos do curso)';
...
cada nova tentativa contém o resultado da tentativa anterior. Isto permite que a avaliação seja
concluída após várias tentativas.</P>
<P>Para mostrar uma avaliação vazia em cada tentativa, seleciona-se <B>Não</B> para esta
opção.</P>';
...
$string['editingcquiz'] = 'Editando avaliação';
$string['editingcquiz_help'] = 'Ao se criar uma avaliação, os conceitos principais são:

* A avaliação contém questões que estejam em uma ou mais páginas
* O banco de questões, que armazena cópias de todas as questões organizadas em categorias
* Questões aleatórias - Um aluno recebe questões diferentes a cada tentativa de resposta à avaliação e estudantes diferentes podem obter diferentes questões.';
$string['editingcquiz_link'] = 'mod/cquiz/edit';
$string['editingcquizx'] = 'Editando avaliação: {$a}';
...
$string['editcquiz'] = 'Editar avaliação';
$string['editcquizquestions'] = 'Editar questões da Avaliação';
$string['emailconfirmbody'] = 'Prezado(a) {$a->username},

obrigada pelo envio das suas respostas à avaliação \'{$a->cquizname}\'
no curso \'{$a->coursename}\'
em {$a->submissiontime}.

Esta mensagem confirma o recebimento das suas respostas.

Você pode acessar a avaliação em {$a->cquizurl}.';
$string['emailconfirmsmall'] = 'Obrigado por submeter as respostas para \'{$a->cquizname}\'';
$string['emailconfirmsubject'] = 'Confirmação de envio: {$a->cquizname}';
$string['emailnotifybody'] = 'Prezado(a) {$a->username},

{$a->studentname} completou a avaliação
\'{$a->cquizname}\' ({$a->cquizurl})
do curso \'{$a->coursename}\'

Para rever a tentativa acesse {$a->cquizreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} completou {$a->cquizname}. Veja {$a->cquizreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} concluiu a avaliação {$a->cquizname}';
$string['emailoverduebody'] = 'Prezado {$a->studentname},

Você iniciou uma tentativa no queziontário \'{$a->cquizname}\' no curso \'{$a->coursename}\' mas não finalizou a tentativa.
...
$string['emailoverduesmall'] = 'Você não finalizou sua tentativa em {$a->cquizname}. Por favor vá para {$a->attemptsummaryurl} antes de {$a->attemptgraceend} se você pretende finalizá-la.';
$string['emailoverduesubject'] = 'Tentativa agora vencida: {$a->cquizname}';
$string['empty'] = 'Vazio';
...
$string['eventattemptdeleted'] = 'Tentativa da avaliação excluída';
$string['eventattemptpreviewstarted'] = 'Pré-visualização da avaliação iniciada';
$string['eventattemptreviewed'] = 'Tentativa da avaliação revisada';
$string['eventattemptsummaryviewed'] = 'Resumo da tentativa da avaliação visualizada';
$string['eventattemptviewed'] = 'Tentativa da avaliação visualizada';
$string['eventeditpageviewed'] = 'Edição da página da Avaliação visualizada';
$string['eventoverridecreated'] = 'Sobreposição da avaliação criada';
$string['eventoverridedeleted'] = 'Sobreposição da avaliação apagada';
$string['eventoverrideupdated'] = 'Sobreposição da avaliação atualizada';
$string['eventquestionmanuallygraded'] = 'Questões avaliadas manualmente';
$string['eventcquizattemptabandoned'] = 'Tentativa da avaliação abandonada';
$string['eventcquizattemptstarted'] = 'Tentativa da avaliação iniciada';
$string['eventcquizattemptsubmitted'] = 'Tentativa da avaliação entregue';
$string['eventcquizattempttimelimitexceeded'] = 'Limite de tempo da avaliação excedida';
$string['eventreportviewed'] = 'Relatório da avaliação visualizada';
...
<p>Você pode controlar quando o feedback geral é mostrado para os estudantes usando a caixa de maracação de escolha "Estudantes podem rever:" no formulário de edição da avaliação.</p>
...
$string['gradehighest'] = 'Nota mais alta entre as tentativas';
$string['grademethod'] = 'Método de avaliação';
$string['grademethod_help'] = '<P>Quando são permitidas diversas tentativas de resposta à avaliação, podem ser configurados 4 modos diversos de cálculo da nota final.
...
$string['gradesdeleted'] = 'Excluir notas da avaliação';
...
$string['guestsno'] = 'Sinto muito, os visitantes não podem ver ou responder avaliações';
...
$string['howquestionsbehave_desc'] = 'Configuração padrão para comportamento das questões na avaliação.';
...
$string['inactiveoverridehelp'] = '* O estudante não tem o grupo correto ou atribuição para tentar a avaliação';
...
$string['initialnumfeedbacks_desc'] = 'Ao criar um nova avaliação, são fornecidas muitas caixas de feedback global em branco. Uma vez que a avaliação foi criada, o formulário mostra o número de campos obrigatórios para o número de feedbacks da avaliação. O ajuste deve ser de pelo menos 1';
...
$string['invalidquestionid'] = 'Identificação inválida da questão';
$string['invalidcquizid'] = 'Identificação inválida da avaliação';
...
$string['link'] = 'Link';
$string['listitems'] = 'Lista dos itens da avaliação';
...
$string['messageprovider:confirmation'] = 'Confirmação de suas próprias submissões da avaliação';
$string['messageprovider:submission'] = 'Notificação de submissões da avaliação';
$string['min'] = 'Min';
...
$string['modulename'] = 'Avaliação com Competências';
$string['modulename_help'] = 'O módulo da avaliação permite ao professor criar e configurar testes de múltipla escolha, verdadeiro ou falso, correspondência e outros tipos de questões. Cada tentativa é corrigida automaticamente e o professor pode optar por fornecer <em>feedback</em> e / ou mostrar as respostas corretas.';
$string['modulename_link'] = 'mod/cquiz/view';
$string['modulenameplural'] = 'Questionários com Competências';
...
$string['name'] = 'Nome';
$string['navigatenext'] = 'Próxima questão';
$string['navigateprevious'] = 'Questão anterior';
$string['navmethod'] = 'Método de navegação';
$string['navmethod_free'] = 'Livre';
$string['navmethod_help'] = 'Quando a navegação sequencial está habilitada, os alunos são obrigados a responder a avaliação na ordem e não podem retornar às páginas anteriores nem passar adiante.';
...
$string['newattemptfail'] = 'Erro: Não foi possível iniciar uma tentativa desta avaliação';
$string['newpage'] = 'Nova página';
$string['newpageevery'] = 'Começar nova página automaticamente';
$string['newpage_help'] = '<P>Para avaliações longas faz sentido dividi-los em várias páginas limitando-se
o números de questões por página. Quando se adicionarem questões na avaliação serão
...
$string['noattempts'] = 'Nenhuma tentativa foi feita nesta avaliação';
...
$string['nogradewarning'] = 'Esta avaliação não foi avaliada e assim não é possível criar feedbacks gerais diferentes para cada nota.';
$string['nomoreattempts'] = 'Não são permitidas outras tentativas';
$string['none'] = 'Nenhum';
$string['noopen'] = 'Sem data de abertura';
$string['nooverridedata'] = 'Você precisa sobrepor ao menos uma configuração da avaliação.';
...
$string['noquestionsincquiz'] = 'Não há questões nesta avaliação.';
...
$string['noreview'] = 'Não é permitido rever esta avaliação';
$string['noreviewattempt'] = 'Você não tem permissão para revisar esta tentativa.';
$string['noreviewshort'] = 'Não permitido';
$string['noreviewuntil'] = 'Não é permitido rever esta avaliação até {$a}';
...
$string['notavailabletostudents'] = 'Nota: Esta avaliação não está disponível para os estudantes neste momento';
$string['notenoughrandomquestions'] = 'Não há questões suficientes na categoria {$a->category} para criar a questão {$a->name} ({$a->id}).';
$string['notenoughsubquestions'] = 'Não foi definido um número suficiente de questões subordinadas<br />Você quer voltar e corrigir esta questão?';
$string['notimedependentitems'] = 'Os itens que dependem de tempo não são suportados pelo módulo avaliação. Você pode estabelecer um tempo de execução para a avaliação inteira, se quiser. Você quer escolher um outro item ou usar este mesmo?';
...
$string['noview'] = 'O usuário que está acessando não tem permissão para ver esta avaliação';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} fizeram {$a->attemptnum} tentativas';
$string['numattemptsmade'] = '{$a} tentativa(s) feita(s) nesta avaliação.';
$string['numberabbr'] = '#';
...
$string['openclosedatesupdated'] = 'Datas de abertura e encerramento da avaliação atualizadas';
$string['optional'] = 'opcional';
$string['orderandpaging'] = 'Ordem e paginação';
$string['orderandpaging_help'] = 'Os números 10, 20, 30, ... em frente de cada questão indicam a a sua ordem. Os números aumentam em intervalos de 10 para possibilitar espaço para questões adicionais a serem inseridas. Para reordená-las, modificar os números e clicar no botão "Reordenar questões".

Para adicionar quebras de página após a questões particulares, marque as caixas ao seu lado e, em seguida, clique em "Adicionar nova página, após as questões selecionadas ".

Para ordenar as questões em um número de páginas, clique no botão "Repaginar" e selecione o número desejado de questões por página.';
$string['orderingcquiz'] = 'Ordenar e paginar';
$string['orderingcquizx'] = 'Ordem e paginação: {$a}';
...
$string['overallfeedback_help'] = '<p>Feedback global é um texto mostrado para o estudante depois que ele terminou, uma tentativa, de responder a avaliação. O texto que é mostrado pode depender da nota que o estudante obteve.</p>
...
<p>Os intervalos de notas podem ser especificados tanto em percentagem, por exemplo "31.41%", ou em um número, por exemplo "7". Se o sua avaliação vale 10, um limite de notas de 7 significa 7 em 10 ou melhor.</p>';
...
$string['overduehandling_desc'] = 'O que deveria acontecer por padrão se um aluno não enviar a avaliação antes de o tempo expirar.';
...
$string['overduehandling_help'] = 'Esta configuração controla o que acontece se o aluno não envia sua tentativa de avaliação antes do tempo expirar. Se o aluno está trabalhando ativamente na avaliação, no momento, então a contagem regressiva irá sempre enviar automaticamente a tentativa para eles, mas se eles deslogare, então essa configuração controla o que acontece.';
$string['overduehandling_link'] = 'mod/cquiz/timing';
$string['overduemustbesubmittedby'] = 'Esta tentativa está vencida. Ela já deveria ter sido enviada. Se você quiser que esta avaliação seja avaliada, você deve enviá-lo até {$a}. Se você não enviar até até lá, nenhuma nota dessa tentativa será levada em conta.';
...
$string['overrideusereventname'] = '{$a->cquiz} - Sobrepor';
$string['page-mod-cquiz-attempt'] = 'Página da tentativa da avaliação';
$string['page-mod-cquiz-edit'] = 'Editar página da avaliação';
$string['page-mod-cquiz-report'] = 'Qualquer página de relatório da avaliação';
$string['page-mod-cquiz-review'] = 'Revisão da página da tentativa da avaliação';
$string['page-mod-cquiz-summary'] = 'Página de resumo da tentativa da avaliação';
$string['page-mod-cquiz-view'] = 'Página de informações da avaliação';
$string['page-mod-cquiz-x'] = 'Qualquer página do módulo avaliação';
$string['pageshort'] = 'P';
...
$string['penaltyscheme_help'] = '<P>Se uma avaliação estiver rodando no modo adaptativo então é permitida uma nova tentativa
após uma resposta errada. Neste caso pode-se desejar impor uma penalidade para cada
resposta errada sendo subtraída da marca final para a questão. O valor da
penalidade é escolhida individualmente para cada questão durante a configuração ou a edição da
questão.</P>
<P>Esta configuração não tem efeito a menos que a avaliação rode no modo
adaptativo.</P>';
$string['percentcorrect'] = 'Percentual correto';
$string['pleaseclose'] = 'O seu pedido foi processado. Você já pode fechar esta janela';
$string['pluginadministration'] = 'Administração da avaliação';
$string['pluginname'] = 'Avaliação com Competências';
$string['popup'] = 'Mostrar a avaliação em uma janela "segura"';
$string['popupblockerwarning'] = 'A seção desse teste está em modo de segurança, o que significa que você precisa fazer a avaliação numa janela segura. Por favor desligue o bloqueador de popups. Obrigado.';
$string['popupnotice'] = 'Os estudantes vão ver esta avaliação em uma janela segura';
...
$string['previewcquiz'] = 'Visualização prévia de {$a}';
$string['previewcquiznow'] = 'Pré-visualizar avaliação agora';
...
$string['questioninuse'] = 'A questão \'{$a->questionname}\' é atualmente usada em:<br />{$a->cquiznames}<br />A questão não será excluída destas avaliações mas apenas das categorias.';
...
$string['questionsinthiscquiz'] = 'Questões nesta avaliação';
...
$string['questiontextisempty'] = '[Texto vazio de questão]';
$string['questiontype'] = 'Tipo de questão {$a}';
$string['questiontypesetupoptions'] = 'Opções de configuração de tipos de questão';
$string['cquiz:addinstance'] = 'Incluir uma nova avaliação';
$string['cquiz:attempt'] = 'Responder avaliações';
$string['cquizavailable'] = 'A avaliação estará disponível até: {$a}';
$string['cquizclose'] = 'Encerrar a avaliação';
$string['cquizclosed'] = 'Esta avaliação foi encerrada em {$a}';
$string['cquizcloses'] = 'A avaliação se encerra';
$string['cquizcloseson'] = 'A avaliação será fechada {$a}';
$string['cquiz:deleteattempts'] = 'Cancelar tentativas';
$string['cquiz:emailconfirmsubmission'] = 'Receber confirmação por email ao enviar';
$string['cquiz:emailnotifysubmission'] = 'Receber notificação dos envios por email';
$string['cquiz:emailwarnoverdue'] = 'Receber uma mensagem de notificação quando uma tentativa se tornar vencida e precisar ser enviada.';
$string['cquiz:grade'] = 'Avaliar manualmente';
$string['cquiz:ignoretimelimits'] = 'Ignorar limite de tempo';
$string['cquizisclosed'] = 'Esta avaliação está fechada';
$string['cquizisclosedwillopen'] = 'Avaliação fechada (abre {$a})';
$string['cquizisopen'] = 'Esta avaliação está aberta';
$string['cquizisopenwillclose'] = 'Avaliação aberta (fecha {$a})';
$string['cquiz:manage'] = 'Gerenciar avaliações';
$string['cquiz:manageoverrides'] = 'Administrar sobreposições da avaliação';
$string['cquiznavigation'] = 'Navegação da avaliação';
$string['cquizopen'] = 'Abrir a avaliação';
$string['cquizopenclose'] = 'Datas de abertura e fechamento';
$string['cquizopenclose_help'] = 'Alunos podem iniciar tentativas apenas depois do horário de abertura e devem completar suas tentativas antes do horário de término.';
$string['cquizopenclose_link'] = 'mod/cquiz/timing';
$string['cquizopened'] = 'Esta avaliação está aberta.';
$string['cquizopenedon'] = 'Esta avaliação será aberta em {$a}';
$string['cquizopens'] = 'A avaliação inicia';
$string['cquizopenwillclose'] = 'Esta avaliação está aberta e será fechado em {$a} as';
$string['cquizordernotrandom'] = 'Ordem da avaliação não embaralhada';
$string['cquizorderrandom'] = '* Ordem da avaliação está embaralhada';
$string['cquiz:preview'] = 'Visualização prévia';
$string['cquiz:regrade'] = 'Reclassificar as tentativas da avaliação';
$string['cquiz:reviewmyattempts'] = 'Rever as suas tentativas';
$string['cquizsettings'] = 'Configurações da avaliação';
$string['cquiztimer'] = 'Cronômetro da avaliação';
$string['cquiz:view'] = 'Ver informação sobre a avaliação';
$string['cquiz:viewreports'] = 'Ver relatórios';
$string['cquizwillopen'] = 'Esta avaliação de aberta {$a}';
...
$string['readytosend'] = 'Você está enviando o sua avaliação para ser avaliado. Tem certeza que quer continuar?';
$string['reattemptcquiz'] = 'Fazer uma outra tentativa';
$string['recentlyaddedquestion'] = 'Questão acrescentada recentemente!';
...
$string['regradenotallowed'] = 'Você não tem permissão para alterar notas nesta avaliação';
$string['regradingquestion'] = 'Reavaliando "{$a}".';
$string['regradingcquiz'] = 'Reavaliando a avaliação "{$a}".';
$string['remove'] = 'Remover';
$string['removeallgroupoverrides'] = 'Excluir todas as sobreposições de grupo';
$string['removeallcquizattempts'] = 'Excluir todas as tentativas da avaliação';
...
$string['reportuserswith'] = 'usuários inscritos haviam tentado a avaliação';
$string['reportuserswithorwithout'] = 'usuários inscritos que haviam ou não tentado a avaliação';
$string['reportuserswithout'] = 'usuários inscritos que não haviam tentado a avaliação';
...
<P>Pode-se restringir o acesso a uma avaliação a sub-redes particulares numa LAN ou
Internet especificando-se uma lista separada por vírgulas dos endereços IP completos ou parciais.</P>
<P>Isto é especialmente útil para uma avaliação pré-determinado ("proctored quiz"), onde se desejar certeza
que somente as pessoas de uma certa sala estiverem aptas a acessar a avaliação.</P>
...
$string['reverttodefaults'] = 'Reverter para a avaliação padrão';
...
$string['reviewclosed'] = 'Depois do fechamento da avaliação';
...
$string['reviewoptionsheading_help'] = 'Estas opções controlam quais informações estudantes podem ver quando eles revisam uma tentativa visualizam os relatórios da avaliação.</p>
...
**Mais tarde, enquanto a avaliação ainda está aberta** se aplica após isto e antes da data de encerramento da avaliação.

**Após a avaliação estar fechada** se aplica após a data de encerramento. Se a avaliação não tem uma data de encerramento, este estado nunca é alcançado.';
...
$string['saveattemptfailed'] = 'Falha ao salvar a tentativa atual da avaliação.';
...
$string['savecquiz'] = 'Gravar esta avaliação inteira';
...
$string['showblocks'] = 'Mostrar blocos durante as tentativas da avaliação';
$string['showblocks_help'] = 'Se definido como sim, então os blocos serão exibidos durante tentativas do cquiz';
...
$string['shufflequestions_help'] = 'Se você ativar, então cada vez que a avaliação for respondida, a ordem das questões nesta seção será embaralhada de forma aleatórida diferente.
...
$string['shufflewithin_help'] = '<p>Se esta opção estiver ativada, então as partes que compõem as questões
   individualmente serão misturadas aleatoriamente toda vez que um estudante
   inicia uma tentativa da avaliação, contanto que esta opção esteja também
   ativada na configuração das questões.</p>

<p>A intenção é simplesmente tornar um pouco mais difícil que os estudantes
   copiem as respostas entre eles.</p>

<p>Isto somente se aplica às questões que têm partes múltiplas, tais como
   questões de múltipla escolha ou questões de associação. Para questões de múltipla escolha
   a ordem das respostas é misturada somente quando esta opção estiver em
   "Sim". Para questões de associação as respostas são sempre misturadas,
   e esta opção controla se adicionalmente a ordem dos pares questão-resposta
   serão misturados.</p>

<p>Esta opção não está relacionada ao uso das questões aleatórias.</p>';
...
$string['specificquestionnotoncquiz'] = 'A questão especificada não se encontra na avaliação especificada';
...
$string['subneterror'] = 'O acesso a esta avaliação é limitado aos endereços de rede autorizados. Atualmente o computador que você está utilizando não está autorizado a utilizar esta avaliação.';
$string['subnetnotice'] = 'Esta avaliação pode ser acessada apenas em áreas definidas da rede. O seu computador não tem a permissão de acesso. Como professor você pode fazer uma prova de visualização.';
$string['subplugintype_cquiz'] = 'Relatório';
$string['subplugintype_cquizaccess'] = 'Regra de acesso';
$string['subplugintype_cquizaccess_plural'] = 'Regras de acesso';
$string['subplugintype_cquiz_plural'] = 'Relatórios';
$string['substitutedby'] = 'será substituído por';
$string['summaryofattempt'] = 'Resumo da tentativa';
...
$string['timedelay'] = 'Você ainda não pode resolver esta avaliação porque existe um tempo de espera definido entre a realização de duas tentativas.';
$string['timeleft'] = 'Tempo restante';
$string['timelimit'] = 'Limite de tempo';
$string['timelimitexeeded'] = 'O limite de tempo da avaliação foi superado!';
$string['timelimit_help'] = '<P align=center><STRONG>Tempo Limite</STRONG></P>
<P>Na configuração padrão as avaliações não têm tempo limite, permitindo-se aos estudantes o tempo
que for necessário para completar a avaliação.</P>
<P>Caso se especifique um tempo limite,  diversas coisas  são feitas para tentar e assegurar
que as avaliações sejam concluídas dentro deste tempo:</P>
<UL>
  ...
  <LI>Quando a contagem terminar, a avaliação é submetida automaticamente com
  ...
  então a avaliação é automaticamente avaliada com zero.
</LI>
</UL>';
...
$string['timelimittxt'] = 'Você terá até {$a} para concluir e enviar a avaliação. Gerencie bem o tempo para responder todas as questões com atenção e revisar as respostas antes do envio.';
...
$string['updatesettings'] = 'Atualizar configuração da avaliação';
...
$string['upgradesure'] = '<div>O módulo avaliação provoca uma mudança profunda nas tabelas e esta atualização ainda não foi testada em modo satisfatório. Faça um backup das tabelas da sua base de dados antes de proceder.</div>';
$string['upgradingcquizattempts'] = 'Atualizando tentativas da avaliação {$a->done}/{$a->outof} (Id da avaliação {$a->info})';
$string['upgradingveryoldcquizattempts'] = 'Atualizando tentativas muito antigas da avaliação {$a->done}/{$a->outof}';
$string['url'] = 'URL';
$string['usedcategorymoved'] = 'Esta categoria foi transferida ao nível do site porque é uma categoria compartilhada ainda em uso em outras avaliações.';
$string['useroverrides'] = 'Sobreposições por usuário';
$string['useroverridesdeleted'] = 'Sobreposições por usuário excluídas';
$string['usersnone'] = 'Nenhum aluno tem acesso a esta avaliação';
$string['validate'] = 'Validar';
$string['viewallanswers'] = 'Ver {$a} avaliações concluídas';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'Você deve se cadastrar neste curso antes de tentar responder esta avaliação';
$string['yourfinalgradeis'] = 'A sua nota final nesta avaliação é {$a}.';

// New in cquiz

$string['attempts_help'] = 'Número máximo de tentativas permitidas para esta avaliação (0 siginifca sem limite)';
$string['helpforum'] = 'Fórum de ajuda';
$string['helpforum_help'] = 'Escolha um fórum para ser indicado aos estudantes para conseguirem ajuda em questões específicas.';
$string['askforhelp'] = 'Você pode pedir ajuda nesta questão em {$a->forum}';
$string['attemptsmaxdelay'] = 'Atraso máximo entre tentativas';
$string['attemptsmaxdelay_help'] = 'Quantidade máxima de tempo que pode decorrer entre duas tentativas consecutivas';
$string['emailgradeearnedbody'] = 'Olá {$a->username},
    
Você recebeu uma nota {$a->grade} na avaliação 
\'{$a->cquizname}\'
do curso \'{$a->coursename}\'.';
$string['emailgradeearnedsmall'] = 'Você recebeu uma nota \'{$a->grade}\' em \'{$a->cquizname}\'';
$string['emailgradeearnedsubject'] = 'Você recebeu uma nota';
$string['emailgradeimprovedbody'] = 'Olá {$a->username},
    
Sua nota na avaliação \'{$a->cquizname}\' 
do curso \'{$a->coursename}\'
melhorou de {$a->previousgrade} para {$a->grade}';
$string['emailgradeimprovedsmall'] = 'Sua nota melhorou de \'{$a->grade}\' para \'{$a->cquizname}\'';
$string['emailgradeimprovedsubject'] = 'Sua nota melhorou';
$string['messageprovider:grade_earned'] = 'Notificação de nota recebida';
$string['cquiz:emailgradeearned'] = 'Receber uma mensagem de notificação quando uma nota tiver sido recebida em uma avaliação.';
$string['generalinfo'] = 'Informações gerais';
$string['generalinfo_desc'] = 'Texto introdutório a ser apresentado ao estudante antes de cada tentativa da avaliação';
$string['of'] = 'de';
$string['point'] = 'ponto(s)';
$string['value'] = 'Valor';
$string['rightquestions'] = 'Você acertou {$a->rightquestions} de {$a->totalquestions} questões';
$string['right'] = 'Correta';
$string['wrong'] = 'Errada';
$string['testyourabilities'] = 'Hora de testar suas habilidades!';
$string['beforeyoustart'] = 'Antes de começar, leia as instruções';
$string['multipleattemptsinstructions'] = 'As atividades avaliativas têm como objetivo verificar a sua aprendizagem como um dos requisitos para aprovação na disciplina. É possível pausar a resposta à atividade e continuar depois.';
$string['singleattemptinstructions'] = 'As atividades avaliativas têm como objetivo verificar a sua aprendizagem como um dos requisitos para aprovação na disciplina. É possível pausar a resposta à atividade e continuar depois.';
$string['secondattempt'] = 'Você pode repetir esta atividade duas vezes. Lembre-se de revisar as respostas antes de enviar a atividade.';
$string['and'] = 'e';
$string['second'] = 'segundo';
$string['seconds'] = 'segundos';
$string['gradingmethod'] = 'Método de avaliação';
$string['highestgrade'] = 'A sua nota final consiste da maior nota obtida nas tentativas da atividade.';
$string['replaceifhigher'] = 'A nota desta avaliação substituirá a nota da avaliação anterior caso seja mais alta.';
$string['datetimeformat'] = 'd/m/Y à\s H:i';
$string['summary'] = 'Resumo';
$string['letsgo'] = 'Tudo certo? Vamos iniciar a avaliação?';
$string['cquiz'] = 'Avaliação';
$string['youarehere'] = 'Você está aqui';
$string['answersaved'] = 'Resposta Salva';
$string['notanswered'] = 'Não Respondida';
$string['chooserightanswerbelow'] = 'Escolha a resposta correta abaixo';
$string['youranswer'] = 'Sua Resposta';
$string['informations'] = 'Informações';
$string['checkyourdashboard'] = 'Veja a correção das questões abaixo ou acesse o {$a} para ver suas conquistas.';
$string['payattention'] = 'Se liga!';
$string['payattentiontxt'] = ' Você pode realizar duas tentativas de resposta e será considerada a maior nota final obtida.';
$string['payattentionto'] = 'Tenha atenção ao {$a}!';
$string['studentguide'] = 'Guia do Participante';
$string['zero'] = 'Zero';
$string['one'] = 'Uma';
$string['two'] = 'Duas';
$string['three'] = 'Três';
...
$string['eight'] = 'Oito';
$string['nine'] = 'Nove';
$string['dashboard'] = 'Meu Perfil';
$string['yourdashboard'] = 'seu perfil';
