...
/**
 * Class to store the options for a {@link cquiz_responses_report}.
 *
...
require_once($CFG->dirroot . '/mod/cquiz/report/attemptsreport_options.php');
 ...
 * @author     Ricardo Drummond
 */
class cquiz_responses_options extends mod_cquiz_attempts_report_options {
    ...
    protected function get_url_params() {
        ...
        if (cquiz_allows_multiple_tries($this->cquiz)) {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->showqtext = get_user_preferences('cquiz_report_responses_qtext', $this->showqtext);
        $this->showresponses = get_user_preferences('cquiz_report_responses_resp', $this->showresponses);
        $this->showright = get_user_preferences('cquiz_report_responses_right', $this->showright);
        if (cquiz_allows_multiple_tries($this->cquiz)) {
            $this->whichtries = get_user_preferences('cquiz_report_responses_which_tries', $this->whichtries);
        }
    }
    ...
    public function update_user_preferences() {
        ...
        set_user_preference('cquiz_report_responses_qtext', $this->showqtext);
        set_user_preference('cquiz_report_responses_resp', $this->showresponses);
        set_user_preference('cquiz_report_responses_right', $this->showright);
        if (cquiz_allows_multiple_tries($this->cquiz)) {
            set_user_preference('cquiz_report_responses_which_tries', $this->whichtries);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_capability('mod/cquiz:deleteattempts', context_module::instance($this->cm->id)) && ($this->attempts != cquiz_attempts_report::ENROLLED_WITHOUT);
    }
