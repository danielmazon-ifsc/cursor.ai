...
/**
 * This file defines the cquiz responses table for showing first or all tries at a question.
 *
...
/**
 * This is a table subclass for displaying the cquiz responses report, showing first or all tries.
 *
 * @package   cquiz_responses
 * @copyright 2017 Viddia (http://viddia.com.br)
 * @author    Jamie Pratt <me@jamiep.org>
 * @author     Ricardo Drummond
 */
class cquiz_first_or_all_responses_table extends cquiz_last_responses_table {
        ...
        foreach ($this->rawdata as $attempt) {
            ...
            for ($try = 1; $try <= $maxtriesinanyslot; $try++) {
                ...
                if ($try !== $maxtriesinanyslot) {
                    $newtablerow->state = cquiz_attempt::IN_PROGRESS;
                }
                $newtablerow->try = $try;
